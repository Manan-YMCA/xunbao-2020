...
from core.views import UserProfileAPIViewSet, UserViewSet, SubmissionAPIView, QuestionAPIView, HintView, LeaderboardAPIViewSet, JWTViewSet
...
router.register('jwt', JWTViewSet, basename='jwt')
